        ...
        <div class="uk-container">
                <div  class="uk-card uk-card-default uk-card-body">
                  <div class="uk-text-center">
                    <br>
                    <?php if (!$loggedin): ?>
                        <h2 class="uk-text-bolder">ANDA BERHASIL LOGOUT!</h2>
                        <h4>Berhasil Logout! Silahkan kembali ke <a href="#" onclick="history.go(-1)">halaman sebelumnya</a> atau <a href="loginregister.php">login kembali</a></h4>
                        <?php endif; ?>
                        <br>
                  </div>
                </div>
